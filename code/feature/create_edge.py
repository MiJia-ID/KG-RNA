...
def get_edge_attr_train(pro_id,th,distance_matrixs):
    edge_index_list = cal_edges(distance_matrixs[:324], protein_idx=pro_id, th=th)
    distance_attrs, cos_similarity_attrs = calculate_edge_attributes(edge_index_list, distance_matrixs[:324], protein_idx=pro_id)
...
def get_edge_attr_test(pro_id,th,distance_matrixs):
    edge_index_list = cal_edges(distance_matrixs[:71], protein_idx=pro_id, th=th)
    distance_attrs, cos_similarity_attrs = calculate_edge_attributes(edge_index_list, distance_matrixs[:71], protein_idx=pro_id)
...
#     print("正在计算")
# save_edgefeats_path = '/home/mijia/egpdi_evolla/af3_data/dataset_dir_train_186_164_test_71/test_71/edge_features/EdgeFeats_predicted_SC_17_181.pkl'
# # os.makedirs("/home/mijia/egpdi_evolla/af3_data/dataset_dir_train_186_164_test_71/train_315/edge_features/")
